  ...
  return (
    <div className="mx-auto w-full max-w-xl px-6 py-14">
      <div className="rounded-3xl border border-[var(--line)] bg-[var(--surface)] p-8">
        <h1 className="text-3xl font-semibold tracking-tight">Create your PostPilot account</h1>
        <p className="mt-2 text-sm text-[var(--muted)]">Start scheduling social posts in minutes.</p>
        ...
        <p className="mt-5 text-sm text-[var(--muted)]">
          ...
          <Link href="/login" className="font-semibold text-[var(--primary)] underline underline-offset-4">
            Log in
          </Link>
        </p>
      </div>
